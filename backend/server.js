...
const currentLeaderboardData = [
  ...
  { name: "Cameron Smith", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Tom McKibbin", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Thorbjorn Olesen", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Stephan Jaeger", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Nico Echavarria", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Jesper Sandborg", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Riki Kawamoto", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Adam Scott", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Bud Cauley", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Shaun Norris", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "JT Poston", score: "+2", position: "T73", total_score: 2, rounds: [], status: "F" },
  { name: "Daniel Young", score: "+2", position: "T73", total_score: 2, rounds: [], status: "16" },
  { name: "Younghan Song", score: "+2", position: "T73", total_score: 2, rounds: [], status: "16" },
  { name: "OJ Farrell", score: "+2", position: "T73", total_score: 2, rounds: [], status: "16" },
